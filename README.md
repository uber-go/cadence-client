...
```bash
git clone git@github.com:uber-go/cadence-client.git $GOPATH/src/github.com/sail1024/cadence
```
...
You can also find the API documentation [here](https://godoc.org/github.com/sail1024/cadence).
